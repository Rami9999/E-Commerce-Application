...
<body class="home-page home-01 ">
                                    ...
                                    @if(Auth::user()->utype ==='ADM')
                                        <li class="menu-item menu-item-has-children parent" >
                                            ...
                                            <ul class="submenu curency" >
												...
												<li class="menu-item">
													<a href="{{route('admin.category')}}" title="categories">Categories</a>
												</li>
												<li class="menu-item">
													<a href="{{route('admin.product')}}" title="products">Products</a>
												</li>
												<li class="menu-item">
													<a href="{{route('admin.homeslider')}}" title="Manage Home Slider">Manage Home Slider</a>
												</li>
												<li class="menu-item">
													<a href="{{route('admin.homecategory')}}" title="Manage Home Category">Manage Home Category</a>
												</li>
												<li class="menu-item">
                                    ...
                                    @else
                                        <li class="menu-item menu-item-has-children parent" >
                                                ...
                                                <ul class="submenu curency" >
													...
													<li class="menu-item">
													<a href="{{route('user.orders')}}" title="All Orders">My Orders</a>
													</li>
													<li class="menu-item">
													<a href="{{route('user.inbox')}}" title="Inbox">Inbox</a>
													</li>
													<li class="menu-item">
    ...
    <script src="https://cdn.tiny.cloud/1/5j837hh8yx7bwxpfi7z9dptffxwtk35l301mp53wegh8gih1/tinymce/5/tinymce.min.js" referrerpolicy="origin"></script>
