			...
			<div class="wrap-main-slide">
				<div class="slide-carousel owl-carousel style-nav-1" data-items="1" data-loop="1" data-nav="true" data-dots="false">
					...
					<div class="item-slide">
						<img src="{{asset('assets/images/sliders')}}/{{$slider->image}}.jpg" alt="here" class="img-slide">
						...
						<div class="product product-style-2 equal-elem ">
							<div class="product-thumnail">
								<a href="{{route('product.details',['slug'=>$sproduct->slug])}}" title="$sproduct->name">
									<figure><img src="{{asset('assets/images/products')}}/{{$sproduct->image}}.jpg" width="800" height="800" alt="$sproduct->name"></figure>
								</a>
						...
						<div class="tab-contents">
							<div class="tab-content-item active" id="digital_1a">
								...
								@foreach($lproducts as $lproduct)
									<div class="product product-style-2 equal-elem ">
										<div class="product-thumnail">
											<a href="{{route('product.details',['slug'=>$lproduct->slug])}}" title="{{$lproduct->short_description}}">
												<figure><img src="{{asset('assets/images/products')}}/{{$lproduct->image}}.jpg" width="800" height="800" alt="{{$lproduct->short_description}}"></figure>
											</a>
											<div class="group-flash">
																	...
																	<div class="product product-style-2 equal-elem ">
																		<div class="product-thumnail">
																			<a href="{{route('product.details',['slug'=>$c_product->slug])}}" title="{{$c_product->name}}">
																				<figure><img src="{{asset('assets/images/products')}}/{{$c_product->image}}.jpg" width="800" height="800" alt="{{$c_product->name}}"></figure>
																			</a>
																			<div class="group-flash">
																				<span class="flash-item new-label">new</span>
																			</div>
