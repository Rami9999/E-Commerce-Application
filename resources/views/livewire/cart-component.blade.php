...
<div class="container">
    ...
    <div class=" main-content-area">
                ...
                <li class="pr-cart-item">
                    ...
                    <div class="quantity">
                        <div class="quantity-input">
                            ...
                            <button class="btn btn-increase"  wire:click.prevent="increase('{{$item->rowId}}')"></button>
                            <button class="btn btn-reduce"  wire:click.prevent="decrease('{{$item->rowId}}')"></button>
                        </div>
                    ...
                    <div class="saveforlater">
                        <a href="#" wire:click.prevent='saveForLater("{{$item->rowId}}")'>
                            <i style="margin-top:15px; " class="fa fa-plus-square fa-2x"></i>
                        </a>
                    </div>
                    <div class="delete">
                        <a  class="btn btn-delete" wire:click.prevent="delete('{{$item->rowId}}')">
                            <span>Delete from your cart</span>
                            <i style="margin-right:10px; margin-bottom:5px;" class="fa fa-times fa-2x text-danger"></i>
                        </a>
                    </div>
                </li>
                @endforeach												
                    ...
                    @if($haveCouponCode ==1)
                        <div class="summary-item">
                            <form wire:submit.prevent="applyCoupon">
                                ...
                                @endif
                                <p class="row-in-form">
                                    <label for="coupon-code">Entre Your Coupon Code</label>
        ...
        @endif
        <div class="wrap-iten-in-cart">
            <h3 class="text-box" style="border-bottom:1px solid; padding-bottom:15px">{{Cart::instance('saveForLater')->count()}} item(s) in Saved For Later</h3>
            ...
            <ul class="products-cart">
                ...
                <li class="pr-cart-item">
                    ...
                    <div class="movetocart">
                        <a href="#" wire:click.prevent='moveToCartFromSavedForLater("{{$item->rowId}}")'>
                            <i style="margin-top:15px; " class="fa fa-minus-square fa-2x"></i>
                        </a>
                    </div>
                    <div class="delete">
                    
                        <a  class="btn btn-delete" wire:click.prevent="deleteFromSavedForLater('{{$item->rowId}}')">
