                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                @if($order->status =='ordered')
                                    <a href="#" class="btn btn-warning pull-right" style="margin-right:20px;" wire:click.prevent="cancel({{$order->id}})">Cancel</a>
                                @endif
                            </div>
                        </div>
                    </div>
                            ...
                            <ul class="products-cart">
                                ...
                                <li class="pr-cart-item">
                                    <div class="product-image">
                                        <figure><img src="{{asset('assets/images/products')}}/{{$item->product->image}}.jpg" alt=""></figure>
                                    </div>
