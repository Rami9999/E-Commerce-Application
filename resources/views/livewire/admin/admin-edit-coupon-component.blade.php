                    ...
                    @endif
                        <form class="form-horizontal" wire:submit.prevent="updateCoupon">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <input type='number' placeholder="Coupon value" class="form-control input-md" wire:model='value'/>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <input type='number' placeholder="Coupon cart_value" class="form-control input-md" wire:model='cart_value'/>
